 ...
 */
export type CreateChannelDTO = Pick<Channel, ChannelRequiredFields | ChannelOptionalFields>

/**
 * Channel update DTO - only includes fields that can be modified
 */
export type UpdateChannelDTO = Partial<Pick<Channel, 'name' | 'description' | 'topic' | 'isArchived' | 'settings'>>